...
检查：年度调价幅度、超量使用价格、"费用"的范围。参照《中华人民共和国民法典》第470条关于合同内容的规定 `[法条原文]`。

### 3. 数据可迁移性和退出

检查：导出格式、导出可用性、终止后访问、导出成本、删除证明。中国法下，《中华人民共和国个人信息保护法》第47条规定了个人信息处理者应在特定情形下主动删除个人信息 `[法条原文]`。
...
根据《中华人民共和国个人信息保护法》第21条、第23条，委托处理个人信息需告知并取得同意，向第三方提供需单独同意 `[法条原文]`。检查：当前列表、变更通知、反对权。
...
中国法下核心规则：
- 《中华人民共和国民法典》第506条明确无效的免责条款 `[法条原文]`
- 《中华人民共和国民法典》第584条可预见规则和第591条减损规则 `[法条原文]`
