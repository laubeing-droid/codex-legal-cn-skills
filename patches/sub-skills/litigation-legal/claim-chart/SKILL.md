...
标记，不发表意见：
- 间接侵权（教唆、帮助）
- 共同侵权（《中华人民共和国民法典》第1168条 `[法条原文]`）
- 故意侵权

### 步骤6：无效门槛（仅无效模式）

- 新颖性（《中华人民共和国专利法》第22条第2款 `[法条原文]`）：全部技术特征在一份对比文件中公开
- 创造性（《中华人民共和国专利法》第22条第3款 `[法条原文]`）：突出的实质性特点和显著的进步（发明）/ 实质性特点和进步（实用新型）
- 清楚性（《中华人民共和国专利法》第26条第3-4款 `[法条原文]`）
- 修改超范围（《中华人民共和国专利法》第33条 `[法条原文]`）
