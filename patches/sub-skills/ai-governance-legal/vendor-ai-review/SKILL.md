...
| 个人信息训练 | 不将包含个人信息的数据用于训练，或已取得个人单独同意（《中华人民共和国个人信息保护法》第23条 `[法条原文]`） | 🔴 未区分数据类型，一刀切授权 |
...
- 涉及个人信息且供应商拒绝签署数据处理协议（参照《中华人民共和国个人信息保护法》第21条 `[法条原文]`）
...
| **安全措施**（《中华人民共和国个人信息保护法》第51条 `[法条原文]`） | 供应商承诺采取必要的安全措施 | SOC2/等保报告、安全事件通知时限、数据泄露通知义务 |
